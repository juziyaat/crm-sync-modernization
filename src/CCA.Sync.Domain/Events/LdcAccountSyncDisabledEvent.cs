...
/// <summary>
/// Raised when synchronization is disabled for an LDC account.
/// </summary>
public sealed class LdcAccountSyncDisabledEvent : DomainEvent
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LdcAccountSyncDisabledEvent"/> class.
    /// </summary>
    /// <param name="ldcAccountId">The ID of the LDC account</param>
    /// <param name="provider">The LDC provider</param>
    public LdcAccountSyncDisabledEvent(Guid ldcAccountId, LdcProvider provider)
    {
